...
final class RectangleLotttie: ShapeItem {

  // MARK: Lifecycle

  required init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: RectangleLotttie.CodingKeys.self)
...
extension RectangleLotttie: @unchecked Sendable { }
