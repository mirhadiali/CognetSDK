...
extension LottieColor: Interpolatable {
  func interpolate(to: LottieColor, amount: CGFloat) -> LottieColor {
    LottieColor(
...
extension LottieVector1D: Interpolatable {
  func interpolate(to: LottieVector1D, amount: CGFloat) -> LottieVector1D {
...
extension Optional: Interpolatable, AnyInterpolatable where Wrapped: Interpolatable {
  func interpolate(to: Wrapped?, amount: CGFloat) -> Wrapped? {
