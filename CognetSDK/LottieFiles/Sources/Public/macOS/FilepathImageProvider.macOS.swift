...
class FilepathImageProvider: AnimationImageProvider {
  ...
  ///
  init(filepath: String, contentsGravity: CALayerContentsGravity = .resize) {
  ...
  /// - Parameter contentsGravity: The contents gravity to use when rendering the images.
  ///
  init(filepath: URL, contentsGravity: CALayerContentsGravity = .resize) {
...
extension FilepathImageProvider: Equatable {
  static func ==(_ lhs: FilepathImageProvider, _ rhs: FilepathImageProvider) -> Bool {
