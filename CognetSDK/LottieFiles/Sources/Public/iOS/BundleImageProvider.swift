...
class BundleImageProvider: AnimationImageProvider {
  ...
  ///
  init(bundle: Bundle, searchPath: String?, contentsGravity: CALayerContentsGravity = .resize) {
    self.bundle = bundle
...
extension BundleImageProvider: Equatable {
  static func ==(_ lhs: BundleImageProvider, _ rhs: BundleImageProvider) -> Bool {
