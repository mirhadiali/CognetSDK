...
class AnimatedSwitch: AnimatedControl {
  ...
  #elseif canImport(AppKit)
  override func handle(_ event: LottieNSControlEvent) {
    super.handle(event)
  ...
  func setIsOn(_ isOn: Bool, animated: Bool, shouldFireHaptics: Bool = true) {
