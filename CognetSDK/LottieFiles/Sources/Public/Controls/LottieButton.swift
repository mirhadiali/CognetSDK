...
struct LottieButton: UIViewConfiguringSwiftUIView {

  // MARK: Lifecycle

  init(animation: LottieAnimation?, action: @escaping () -> Void) {
  ...
  func configure(_ configure: @escaping (AnimatedButton) -> Void) -> Self {
    var copy = self
